    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{$project->user_id == Auth::id() ? route('admin.projects.show', $project) : route('admin.technologies.show', $technology)}}"><i class="fa-solid fa-magnifying-glass"></i></a></td>
            </tr>
